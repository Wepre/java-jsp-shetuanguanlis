                                                ...
                                                <table width="100%" height="18" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td width="24%" align="center" valign="bottom"><span
                                                                class="STYLE3">社员风彩</span></td>
                                                        <td width="64%" valign="bottom">&nbsp;</td>
                                                        <td width="12%" valign="bottom"><a
                                                                href="sheyuanxinxilist.jsp"><font class="STYLE3">更多&gt;&gt;</font></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="738" height="41" background="qtimages/1_02_01_02_01.gif">
                                                <table width="100%" height="18" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td width="24%" align="center" valign="bottom"><span
                                                                class="STYLE3">社团信息</span></td>
                                                        <td width="64%" valign="bottom">&nbsp;</td>
                                                        <td width="12%" valign="bottom"><a
                                                                href="shetuanxinxilist.jsp"><font class="STYLE3">更多&gt;&gt;</font></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="714" height="100%" valign="top">
                                                            <table width="100%" border="1" align="center"
                                                                ...
                                                                <tr>
                                                                    <td width="30" align="center" bgcolor="CCFFFF">序号
                                                                    </td>
                                                                    ...
                                                                    <td width="30" align="center" bgcolor="CCFFFF">详细
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="30" align="center"><a
                                                                            href="shetuanxinxidetail.jsp?id=<%=id%>">详细</a>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                    }
